...
{
    event Action<bool> OnChangeTurn;
    List<PieceType> SpecialAttackers { get; }
    /// <summary>
    ...
    void ShowSpecialAttackRange();
    void HideSpecialAttackRange();

    bool? ExecuteSpecialAttack(int tileID);
