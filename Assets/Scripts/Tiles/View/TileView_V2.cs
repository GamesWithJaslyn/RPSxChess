...
/// </summary>
public class TileView_V2 : MonoBehaviour
{
    [Header("Tile Properties")]
    public ITileModel _model { get; private set; }
    [SerializeField] private int _id;
    private IPieceModel_V2 _piece;
    ...
    public void Init(ITileModel model, IBoardModel_V2 boardModel)
    {
        _model = model;
    ...
    public ITileModel GetTileModel() { return _model; }
    private void OnDestroy() { _model.OnTileValid -= MarkAsValid; }
}
